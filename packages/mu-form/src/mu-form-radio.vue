<template>
    <div class='form-condition' :style='{width: width}'>
        ...
        <div class='input' :style='{"margin-left": labelWidth}'>
            <span class='radioItem' v-for='(item, i) in datas' :key='i' @click='change(item)'>
                <img v-if='item.value==value' src='../img/radio-active.png'>
                <img v-else src='../img/radio-gray.png'>
